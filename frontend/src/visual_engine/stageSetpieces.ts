...
const ACTIVE_BONUS_SETPIECES: Array<{ needle: string; setpiece: StageSetpiece }> = [
  {
    ...
    setpiece: {
      ...
      rig: "顶部吊架、纵向窗格、拱形合唱廊。",
      lighting: "顶部冷色吊灯和下压式礼堂光柱会持续往中心汇聚。",
  ...
  },
  {
    ...
    setpiece: {
      ...
      lighting: "双侧幕光会更柔地包过来，像近距离呼吸的丝绒侧洗。",
  ...
  },
  {
    ...
    setpiece: {
      ...
      rig: "拱廊窗、柔性立柱、贴地灯带。",
      lighting: "地面脚灯和拱券侧洗会让整条回廊更像暖色慢舞场。 ",
  ...
  },
  {
    ...
    setpiece: {
      ...
      rig: "纵向窗格、冷色回廊、节制型灯带。",
      lighting: "冷色窗格灯会按秩序轮流下扫，强调声部式的前后层次。",
  ...
  },
  {
    ...
    setpiece: {
      ...
      rig: "中央王座、侧向锻柱、上压式火口。",
      lighting: "下打熔口和斜向硬光会轮番砸下来，像锻炉里不断翻起的热浪。",
  ...
  },
  {
    ...
    setpiece: {
      ...
      rig: "折射门框、回旋通道、相位环走廊。",
      lighting: "折返扫描光会在门框之间来回跳，相位感会明显比普通旋涡更强。 ",
  ...
  },
  {
    ...
    setpiece: {
      ...
      rig: "跑道灯钉、护栏光带、远端冲刺线。",
      lighting: "侧边护栏和远端灯点会像赛道一样连续往前送，让速度感更成体系。",
...
const CASCADE_SETPIECES: Record<Exclude<VisualParameters["sceneCascade"], "neutral">, StageSetpiece> = {
  "aurora-dais": {
    ...
    rig: "抬升台阶、穹顶拱幕、礼台光环。",
    lighting: "上方礼台光柱会按层次一层层打开，把中心人物感托起来。",
  ...
  "velvet-arcade": {
    ...
    lighting: "慢速侧洗和脚灯会顺着长廊推进，让空间像在轻轻往前漂。 ",
  ...
  "forge-ritual": {
    ...
    rig: "锻造横梁、碎片雨、熔口热区。",
    lighting: "上压式硬光和下打热口会一起把空间变成工地般的高压现场。 ",
  ...
  "prism-vortex": {
    ...
    rig: "旋转门框、折射三角、相位回圈。",
    lighting: "折射光条会以不同角度轮流扫过，像系统内部的信号在同步。 ",
  ...
  "tide-runway": {
    ...
    rig: "前冲跑道、节拍护栏、远端灯点。",
    lighting: "跑道边灯会向远端连续递进，让速度和方向都更直接。 ",
  ...
  "eclipse-altar": {
    ...
    rig: "祭坛圆环、辐条阴影、仪式化地面。",
    lighting: "低位暗光和祭坛边缘的冷色描边会把仪式感慢慢压上来。 ",
